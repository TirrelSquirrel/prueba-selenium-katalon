...
WebUI.callTestCase(findTestCase('Test_3/Temp Mail/Get_temp_mail'), [:], FailureHandling.STOP_ON_FAILURE)

if ((GlobalVariable.emailRegister != '') || (GlobalVariable.emailRegister != null)) {
    WebUI.setText(findTestObject('Amazon/Registro/Page_Registro de Amazon/input_ES 34_email'), GlobalVariable.emailRegister)
} else {
    WebUI.setText(findTestObject('Amazon/Registro/Page_Registro de Amazon/input_ES 34_email'), GlobalVariable.alternativeemailRegister)
}
